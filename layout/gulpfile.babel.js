...
const compileVideo = () =>
      gulp.src(config.paths.src.video)
...
const watchVideo = () => gulp.watch(config.paths.watch.video, gulp.series(compileVideo));
...
const buildStuff = gulp.parallel(compileFavicon, compileFonts, compileVideo, compileJs, compileWebp, compileImages, compileCSS);
const watch = gulp.parallel(watchHTML, watchCSS, watchJs, watchImages, watchFonts, watchVideo, watchFavicon, watchSvgIcon);
